...
interface DeleteStaleInvitationsJobPayload {}
...
export default class DeleteStaleInvitationsJob extends Job {
   ...
   * Base Entry point
   */
  async handle(payload: DeleteStaleInvitationsJobPayload) {
   ...
   */
  async rescue(payload: DeleteStaleInvitationsJobPayload, error: Error) {
    logger.error(
